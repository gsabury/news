...
function get_news_for_home_sidebar_section5()
{
    register_widget('Home_Sidebar_Section_5_Widget');
}

add_action("widgets_init", "get_news_for_home_sidebar_section5");

class Home_Sidebar_Section_5_Widget extends WP_Widget
{
    function __construct()
    {
        parent::__construct(
            // Widget ID, Base ID
            'home_sidebar_section_5',
            // Widget Name
            "Home Sidebar Section 5",
            array(
                'description' => ""
            )
        );
    ...
    function widget($args, $instance)
    {
        ...
        $home_sidebar_section5_query = new WP_Query($query_args);

?>
        <div class="sidebar-news-style2">
            <h1><?= $title ?></h1>
            <?php $counter = 0; ?>
            <?php while ($home_sidebar_section5_query->have_posts()): $home_sidebar_section5_query->the_post(); ?>
                <?php if ($counter == 0): ?>
                    <div class="news-img">
                ...
                <?php while ($home_sidebar_section5_query->have_posts()): $home_sidebar_section5_query->the_post(); ?>
                    <?php if ($counter > 0): ?>
                        <div class="news-items row">
                            <div class="news-items-img col-lg-4 col-md-4 col-sm-4 col-4">
                                <div class="inner">
                                    <a href="<?php the_permalink() ?>">
                                        <img
                                            class="img-fluid"
